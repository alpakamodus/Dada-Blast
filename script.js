...
function draw(){
    ...
    ctx.fillRect(block1X-boardSize/6/2,blockY-boardSize/6/2,boardSize/6,boardSize/6);
    ctx.fillRect(block2X-boardSize/6/2,blockY-boardSize/6/2,boardSize/6,boardSize/6);
    ctx.fillRect(block3X-boardSize/6/2,blockY-boardSize/6/2,boardSize/6,boardSize/6);
}
